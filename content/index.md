...
<div style="display: flex; align-items: flex-start; gap: 20px; margin: 20px 0;">
  <div style="flex: 1;">
    <p>I am a Postdoctoral Associate working with Prof. Song Han at MIT. I also work closely with Prof. Ana Klimović from ETH. I obtained my Ph.D. degree from NTU in 2023, advised by Prof. Tianwei Zhang and Prof. Yonggang Wen. Before that, I received my M.Sc. degree from National University of Singapore in 2020 and my B.Eng. degree from Zhejiang University in 2018.</p>
  </div>
...
My research focuses on the intersection of **machine learning** and **software engineering**, with particular emphasis on:

- **🛡️ Code Security & Vulnerability Detection**: Developing AI-powered tools to identify security vulnerabilities in source code, with a focus on Python and other programming languages
- **🚀 Transformer Optimization**: Researching efficient token merging techniques and architectural improvements to accelerate transformer models while preserving performance
- **🧠 Deep Learning for Software Engineering**: Applying machine learning techniques to solve complex software engineering problems, including code analysis and automated testing
- **📊 3D Point Cloud Processing**: Exploring transformer architectures for 3D point cloud data and understanding token requirements for optimal performance
- **🔍 Natural Language Processing**: Working on language models and their applications in code understanding and generation

I am particularly interested in bridging the gap between theoretical machine learning research and practical software engineering applications, with the goal of creating tools that can improve software quality and security.
